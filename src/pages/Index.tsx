  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Mr. Barber</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Mr. Barber in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Mr. Barber | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Mr. Barber | Premium Barbershop Berlin" />
        <meta
